...
from scrapy_cloudflare_middleware import middlewares

class CoinsSpider(CrawlSpider):
    name = 'coins'
    allowed_domains = ['web.archive.org']
    start_urls = ['https://web.archive.org/web/20181230231928/https://coinmarketcap.com/']
    ...
    def parse_item(self, response):
        yield {
            'name': response.xpath("normalize-space(//h1[@class='details-panel-item--name']/span/text()[2])").get,
